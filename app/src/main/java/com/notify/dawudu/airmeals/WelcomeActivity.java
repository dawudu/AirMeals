...
public class WelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //When a user presses skip, start the Main Activity
    ...
    private void startLoginActivity() {
        ...
        setFirstTimeStartStatus(false);///////Check This
        startActivity(new Intent(WelcomeActivity.this, LoginOption.class));
        finish();
